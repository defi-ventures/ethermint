...
import (
	...
	_ "github.com/defi-ventures/ethermint/client/docs/statik"
	...
	"github.com/defi-ventures/ethermint/x/feemarket"
	feemarketkeeper "github.com/defi-ventures/ethermint/x/feemarket/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".blockxd")
}

const appName = "blockxd"
